...
// Definitions by: Boris Yankov <https://github.com/borisyankov/>, John Reilly
// <https://github.com/johnnyreilly> Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped
...
declare namespace JQueryUI {
    ...
    interface DatepickerOptions {
         ...
         * altFormat option to change the format of the date within this field. Leave as blank for no
         * alternate field.
         */
        altField?: any; // Selector, jQuery or Element
        /**
         * The dateFormat to be used for the altField option. This allows one date format to be shown to the
         * user for selection purposes, while a different format is actually sent behind the scenes. For a
        ...
        autoSize?: boolean;
        /**
         * A function that takes an input field and current datepicker instance and returns an options object
         * to update the datepicker with. It is called just before the datepicker is displayed.
         */
        ...
        /**
         * A URL of an image to use to display the datepicker when the showOn option is set to "button" or
         * "both". If set, the buttonText option becomes the alt value and is not directly displayed.
         */
        buttonImage?: string;
        /**
         * Whether the button image should be rendered by itself instead of inside a button element. This
         * option is only relevant if the buttonImage option has also been set.
         */
        buttonImageOnly?: boolean;
        /**
         * The text to display on the trigger button. Use in conjunction with the showOn option set to
         * "button" or "both".
         */
        buttonText?: string;
        /**
         * A function to calculate the week of the year for a given date. The default implementation uses the
         * ISO 8601 definition: weeks start on a Monday; the first week of the year contains the first
        ...
        changeMonth?: boolean;
        /**
         * Whether the year should be rendered as a dropdown instead of text. Use the yearRange option to
         * control which years are made available for selection.
         */
        changeYear?: boolean;
        /**
        ...
        closeText?: string;
        /**
         * When true, entry in the input field is constrained to those characters allowed by the current
         * dateFormat option.
         */
        constrainInput?: boolean;
        /**
         * The text to display for the current day link. Use the showButtonPanel option to display this
         * button.
         */
        currentText?: string;
        /**
        ...
        dayNames?: string[];
        /**
         * The list of minimised day names, starting from Sunday, for use as column headers within the
         * datepicker.
         */
        dayNamesMin?: string[];
        /**
        ...
        /**
         * Set the date to highlight on first opening if the field is blank. Specify either an actual date
         * via a Date object or as a string in the current dateFormat, or a number of days from today (e.g.
         * +7) or a string of values and periods ('y' for years, 'm' for months, 'w' for weeks, 'd' for days,
         * e.g. '+1m +7d'), or null for today. Multiple types supported: Date: A date object containing the
         * default date. Number: A number of days from today. For example 2 represents two days from today
         * and -1 represents yesterday. string: A string in the format defined by the dateFormat option, or a
         * relative date. Relative dates must contain value and period pairs; valid periods are "y" for
         * years, "m" for months, "w" for weeks, and "d" for days. For example, "+1m +7d" represents one
         * month and seven days from today.
         */
        defaultDate?: any; // Date, number or string
        /**
         * Control the speed at which the datepicker appears, it may be a time in milliseconds or a string
         * representing one of the three predefined speeds ("slow", "normal", "fast").
         */
        duration?: string;
        /**
        ...
        gotoCurrent?: boolean;
        /**
         * Normally the previous and next links are disabled when not applicable (see the minDate and maxDate
         ...
         * Number: A number of days from today. For example 2 represents two days from today and -1
         * represents yesterday. string: A string in the format defined by the dateFormat option, or a
         * relative date. Relative dates must contain value and period pairs; valid periods are "y" for
         * years, "m" for months, "w" for weeks, and "d" for days. For example, "+1m +7d" represents one
         * month and seven days from today.
         */
        ...
        monthNames?: string[];
        /**
         * The list of abbreviated month names, as used in the month header on each datepicker and as
         * requested via the dateFormat option.
         */
        monthNamesShort?: string[];
        /**
         * Whether the prevText and nextText options should be parsed as dates by the formatDate function,
         * allowing them to display the target month names for example.
         */
        navigationAsDateFormat?: boolean;
        /**
         * The text to display for the next month link. With the standard ThemeRoller styling, this value is
         * replaced by an icon.
         */
        nextText?: string;
        /**
        ...
        /**
         * Called when the datepicker moves to a new month and/or year. The function receives the selected
         * year, month (1-12), and the datepicker instance as parameters. this refers to the associated input
         * field.
         */
        onChangeMonthYear?: (year: number, month: number, inst: any) => void;
        /**
         * Called when the datepicker is closed, whether or not a date is selected. The function receives the
         * selected date as text ("" if none) and the datepicker instance as parameters. this refers to the
         * associated input field.
         */
        onClose?: (dateText: string, inst: any) => void;
        /**
         * Called when the datepicker is selected. The function receives the selected date as text and the
         * datepicker instance as parameters. this refers to the associated input field.
         */
        onSelect?: (dateText: string, inst: any) => void;
        /**
         * The text to display for the previous month link. With the standard ThemeRoller styling, this value
         * is replaced by an icon.
         */
        prevText?: string;
        /**
         * Whether days in other months shown before or after the current month are selectable. This only
         * applies if the showOtherMonths option is set to true.
         */
        selectOtherMonths?: boolean;
        /**
         * The cutoff year for determining the century for a date (used in conjunction with dateFormat 'y').
         * Any dates entered with a year value less than or equal to the cutoff year are considered to be in
         * the current century, while those greater than it are deemed to be in the previous century.
         * Multiple types supported: Number: A value between 0 and 99 indicating the cutoff year. string: A
         * relative number of years from the current year, e.g., "+3" or "-5".
         */
        shortYearCutoff?: any; // number or string
        /**
         * The name of the animation used to show and hide the datepicker. Use "show" (the default),
         * "slideDown", "fadeIn", any of the jQuery UI effects. Set to an empty string to disable animation.
         */
        showAnim?: string;
        /**
         * Whether to display a button pane underneath the calendar. The button pane contains two buttons, a
         * Today button that links to the current day, and a Done button that closes the datepicker. The
         * buttons' text can be customized using the currentText and closeText options respectively.
         */
        showButtonPanel?: boolean;
        /**
         * When displaying multiple months via the numberOfMonths option, the showCurrentAtPos option defines
         * which position to display the current month in.
         */
        ...
        /**
         * When the datepicker should appear. The datepicker can appear when the field receives focus
         * ("focus"), when a button is clicked ("button"), or when either event occurs ("both").
         */
        showOn?: string;
        /**
         * If using one of the jQuery UI effects for the showAnim option, you can provide additional settings
         * for that animation via this option.
         */
        showOptions?: any; // TODO
        /**
         * Whether to display dates in other months (non-selectable) at the start or end of the current
        ...
        stepMonths?: number;
        /**
         * The text to display for the week of the year column heading. Use the showWeek option to display
         * this column.
         */
        weekHeader?: string;
        /**
         * The range of years displayed in the year drop-down: either relative to today's year ("-nn:+nn"),
         * relative to the currently selected year ("c-nn:c+nn"), absolute ("nnnn:nnnn"), or combinations of
         * these formats ("nnnn:-nn"). Note that this option only affects what appears in the drop-down, to
...
interface JQuery {
    ...
    datepicker(): JQuery;
    /**
     * Removes the datepicker functionality completely. This will return the element back to its pre-init
     * state.
     *
     ...
     * @param onSelect A callback function when a date is selected. The function receives the date text and
     *     date picker instance as parameters.
     * @param settings The new settings for the date picker.
     * @param pos The position of the top/left of the dialog as [x, y] or a MouseEvent that contains the
     *     coordinates. If not specified the dialog is centered on the screen.
     */
    ...
    /**
     * Sets the date for the datepicker. The new date may be a Date object or a string in the current date
     * format (e.g., "01/26/2009"), a number of days from today (e.g., +7) or a string of values and periods
     * ("y" for years, "m" for months, "w" for weeks, "d" for days, e.g., "+1m +7d"), or null to clear the
     * selected date.
     *
    ...
    /**
     * Open the date picker. If the datepicker is attached to an input, the input must be visible for the
     * datepicker to be shown.
     *
     ...
     * @param methodName 'option'
     * @param optionName 'altField'
     * @param altFieldValue An input element that is to be updated with the selected date from the
     *     datepicker. Use the altFormat option to change the format of the date within this field. Leave as
     *     blank for no alternate field.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'altFormat'
     * @param altFormatValue The dateFormat to be used for the altField option. This allows one date format
     *     to be shown to the user for selection purposes, while a different format is actually sent behind
     *     the scenes. For a full list of the possible formats see the formatDate function
     */
     ...
     * @param methodName 'option'
     * @param optionName 'autoSize'
     * @param autoSizeValue Set to true to automatically resize the input field to accommodate dates in the
     *     current dateFormat.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'beforeShow'
     * @param beforeShowValue A function that takes an input field and current datepicker instance and
     *     returns an options object to update the datepicker with. It is called just before the datepicker
     *     is displayed.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'buttonImage'
     * @param buttonImageValue A URL of an image to use to display the datepicker when the showOn option is
     *     set to "button" or "both". If set, the buttonText option becomes the alt value and is not directly
     *     displayed.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'buttonImageOnly'
     * @param buttonImageOnlyValue Whether the button image should be rendered by itself instead of inside a
     *     button element. This option is only relevant if the buttonImage option has also been set.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'buttonText'
     * @param buttonTextValue The text to display on the trigger button. Use in conjunction with the showOn
     ...
     * @param methodName 'option'
     * @param optionName 'calculateWeek'
     * @param calculateWeekValue A function to calculate the week of the year for a given date. The default
     *     implementation uses the ISO 8601 definition: weeks start on a Monday; the first week of the year
     ...
     * @param methodName 'option'
     * @param optionName 'changeYear'
     * @param changeYearValue Whether the year should be rendered as a dropdown instead of text. Use the
     ...
     * @param methodName 'option'
     * @param optionName 'closeText'
     * @param closeTextValue The text to display for the close link. Use the showButtonPanel option to
     *     display this button.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'constrainInput'
     * @param constrainInputValue When true, entry in the input field is constrained to those characters
     ...
     * @param methodName 'option'
     * @param optionName 'currentText'
     * @param currentTextValue The text to display for the current day link. Use the showButtonPanel option
     ...
     * @param methodName 'option'
     * @param optionName 'dateFormat'
     * @param dateFormatValue The format for parsed and displayed dates. For a full list of the possible
     ...
     * @param methodName 'option'
     * @param optionName 'dayNames'
     * @param dayNamesValue The list of long day names, starting from Sunday, for use as requested via the
     *     dateFormat option.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'dayNamesMin'
     * @param dayNamesMinValue The list of minimised day names, starting from Sunday, for use as column
     ...
     * @param methodName 'option'
     * @param optionName 'dayNamesShort'
     * @param dayNamesShortValue The list of abbreviated day names, starting from Sunday, for use as
     *     requested via the dateFormat option.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'defaultDate'
     * @param defaultDateValue A number of days from today. For example 2 represents two days from today and
     ...
     * @param methodName 'option'
     * @param optionName 'defaultDate'
     * @param defaultDateValue A string in the format defined by the dateFormat option, or a relative date.
     *     Relative dates must contain value and period pairs; valid periods are "y" for years, "m" for
     *     months, "w" for weeks, and "d" for days. For example, "+1m +7d" represents one month and seven
     *     days from today.
     */
     ...
     * @param methodName 'option'
     * @param optionName 'duration'
     * @param durationValue Control the speed at which the datepicker appears, it may be a time in
     *     milliseconds or a string representing one of the three predefined speeds ("slow", "normal",
     *     "fast").
     */
     ...
     * @param methodName 'option'
     * @param optionName 'gotoCurrent'
     * @param gotoCurrentValue When true, the current day link moves to the currently selected date instead
     *     of today.
     */
    ...
    datepicker(methodName: 'option', optionName: string, ...otherParams: any[]): any; // Used for getting and
                                                                                      // setting options
...
interface JQueryStatic {
    ...
    widget: JQueryUI.Widget;
    Widget: JQueryUI.Widget;
    number(stringNumber:String, radix:Number):String;
}
