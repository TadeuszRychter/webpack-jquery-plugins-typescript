...
interface JQueryStatic {
    ...
    number(data: any, decimalPoints: number) : string;
...
interface JQuery {
    ...
    scrollTop(func: (index: number, width: number) => number|string): JQuery;
    /**
     ...
     * Adds scrollpanel
     */
    scrollpanel(options: string, repeat: boolean) : void;
